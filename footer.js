...
//	console.log(viewname);
	...
	if (content != null && content.trim().length != 0) {
		if (content == "sampleData") {
			...
			//remove adsense div
			$( ".adsense" ).replaceWith('<a href="//www.bluehost.com/track/codebeautify/" target="_blank"><img border="0" src="//bluehost-cdn.com/media/partner/images/codebeautify/120x120/bh-120x120-03-dy.png"></a>');			
